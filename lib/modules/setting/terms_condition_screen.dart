...
HtmlPaddings? edgeInsetsToHtmlPaddings(BuildContext context, EdgeInsetsGeometry? edgeInsets) {
  if (edgeInsets == null) return null;
  final resolved = edgeInsets.resolve(Directionality.of(context));
              ...
              children: [
                Html(
                  ...
                  style: {
                    ...
                    "th": Style(
                      padding: edgeInsetsToHtmlPaddings(context, const EdgeInsets.all(6)),
